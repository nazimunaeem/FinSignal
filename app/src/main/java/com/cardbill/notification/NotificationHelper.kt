...
import com.cardbill.CardBillApp
import com.cardbill.MainActivity
import com.cardbill.R
import com.cardbill.data.local.entity.BillWithCard

object NotificationHelper {

    private const val ACTION_MARK_PAID = "com.cardbill.ACTION_MARK_PAID"
    ...
    fun showDueDateReminder(context: Context, bill: BillWithCard, daysLeft: Int) {
        ...
        val notification = NotificationCompat.Builder(context, CardBillApp.DUE_DATE_CHANNEL)
    ...
    fun showOverdueAlert(context: Context, bill: BillWithCard) {
        ...
        val notification = NotificationCompat.Builder(context, CardBillApp.OVERDUE_CHANNEL)
